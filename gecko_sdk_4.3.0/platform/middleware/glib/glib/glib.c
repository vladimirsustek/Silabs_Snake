 ...
 */
static __INLINE void GLIB_colorTranslate24bppInl(uint32_t color, uint8_t *red,
...
EMSTATUS GLIB_contextInit(GLIB_Context_t *pContext)
{
	...
	{ 0, 0, pTmpDisplayGeometry->xSize - 1, pTmpDisplayGeometry->ySize - 1 };
 ...
 ******************************************************************************/
void GLIB_colorTranslate24bpp(uint32_t color, uint8_t *red, uint8_t *green,
		uint8_t *blue)
{
