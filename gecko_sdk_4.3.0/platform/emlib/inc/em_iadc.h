...
#endif
	/** GPIO port A pin 0 */
	iadcNegInputPortAPin0 = (_IADC_SCAN_PORTNEG_PORTA
			<< (_IADC_SCAN_PORTNEG_SHIFT - _IADC_SCAN_PINNEG_SHIFT)),
...
{
	/** Ground  */
	iadcPosInputGnd = (_IADC_SCAN_PORTPOS_GND
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)),

	/** Avdd / 4  */
	iadcPosInputAvdd = (_IADC_SCAN_PORTPOS_SUPPLY
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)) | 0,

	/** Vddio / 4  */
	iadcPosInputVddio = (_IADC_SCAN_PORTPOS_SUPPLY
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)) | 1,
...
#else
	/** Vss  */
	iadcPosInputVss = (_IADC_SCAN_PORTPOS_SUPPLY
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)) | 2,

	/** Vss  */
	iadcPosInputVssaux = (_IADC_SCAN_PORTPOS_SUPPLY
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)) | 3,
#endif

	/** Dvdd / 4  */
	iadcPosInputDvdd = (_IADC_SCAN_PORTPOS_SUPPLY
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)) | 4,

	/** Decouple  */
	iadcPosInputDecouple = (_IADC_SCAN_PORTPOS_SUPPLY
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)) | 7,

#if defined(_IADC_SCAN_PORTPOS_DAC0)
	/** Direct connection to DAC_0 input pin */
	iadcPosInputDac0 = (_IADC_SCAN_PORTPOS_DAC0
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)),
#endif
#if defined(_IADC_SCAN_PORTPOS_PADANA0)
	/** Direct connection to Pad_ana_0 input pin */
	iadcPosInputPadAna0 = (_IADC_SCAN_PORTPOS_PADANA0
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)),
#endif
#if defined(_IADC_SCAN_PORTPOS_PADANA2)
	/** Direct connection to Pad_ana_2 input pin */
	iadcPosInputPadAna2 = (_IADC_SCAN_PORTPOS_PADANA2
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)),
#endif
  ...
  iadcPosInputPosRef    = (_IADC_SCAN_PORTPOS_PADREFPOS << (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)),
	...
	/** GPIO port A pin 0 */
	iadcPosInputPortAPin0 = (_IADC_SCAN_PORTPOS_PORTA
			<< (_IADC_SCAN_PORTPOS_SHIFT - _IADC_SCAN_PINPOS_SHIFT)),
...
void
IADC_init(IADC_TypeDef *iadc, const IADC_Init_t *init,
		const IADC_AllConfigs_t *allConfigs);
void
IADC_reset(IADC_TypeDef *iadc);
void
IADC_initScan(IADC_TypeDef *iadc, const IADC_InitScan_t *init,
		const IADC_ScanTable_t *scanTable);
void
IADC_updateScanEntry(IADC_TypeDef *iadc, uint8_t id,
		IADC_ScanTableEntry_t *entry);
void
IADC_setScanMask(IADC_TypeDef *iadc, uint32_t mask);
void
IADC_initSingle(IADC_TypeDef *iadc, const IADC_InitSingle_t *init,
		const IADC_SingleInput_t *input);
void
IADC_updateSingleInput(IADC_TypeDef *iadc, const IADC_SingleInput_t *input);
uint8_t
IADC_calcSrcClkPrescale(IADC_TypeDef *iadc, uint32_t srcClkFreq,
		uint32_t cmuClkFreq);
uint32_t
IADC_calcAdcClkPrescale(IADC_TypeDef *iadc, uint32_t adcClkFreq,
...
{
	return (uint8_t) ((iadc->SINGLEFIFOSTAT
			& _IADC_SINGLEFIFOSTAT_FIFOREADCNT_MASK)
